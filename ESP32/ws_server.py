...
class WebSocketServer:
    def __init__(self, page, connectionCallback,disconnectionCallback, max_connections=3):
        self._listen_s = None
    ...
    def _accept_conn(self):
        ...
        self._clients.append(self._make_client(WebSocketConnection(remote_addr, cl, self.remove_connection), self.received))
        
        print("Nouveau client : " + str(len(self._clients)))


    def _make_client(self, conn, receivedCallback):
        self.isConnected = True
        print(">>> New Client")
        return WSClient(conn, receivedCallback)
